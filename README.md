...
7. **Events:** three event cards with date badges.
8. **Gallery:** masonry grid with a full-screen lightbox (keyboard, swipe, focus trap).
9. **Quote:** centred quote over a mandala background.
10. **Community:** call to action on a glass card over a parallax image.
11. **Newsletter:** email sign-up form.
12. **Footer:** links, social icons and photo credits.
